(function($) {
  $(document).ready(function() {
    ...
    console.log('https://guides.library.upenn.edu' + currentUrl);
    var currentSearch = $("#s-lg-guide-tabs a[href='" + currentUrl + "'], #s-lg-guide-tabs a[href='https://guides.library.upenn.edu" + currentUrl + "']");
    ...
    currentNavContent = $("#s-lg-side-nav-content #s-lg-guide-tabs .nav-pills .nav-pills.nav-stacked li a[href='" + currentUrl + "'], \
                           #s-lg-side-nav-content #s-lg-guide-tabs .nav-pills .nav-pills.nav-stacked li a[href='https://guides.library.upenn.edu" + currentUrl + "']");
