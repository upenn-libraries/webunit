...
jQuery(function($){
    ...
    //var $container = $('.blacklight-catalog-landing #main-container, .courserespages.homepage #homepagecontent, .bigtabs #whitearea');

    /* Custom location logic for COVID-19: only show the alert for the Catalog. */
    var $container = $('#catalog-main');
