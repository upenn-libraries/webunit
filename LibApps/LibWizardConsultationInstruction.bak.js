...
function pageTasks($) {
  var $form = $('#80482e7c12bf24ad1bc736d4e98dd971');
  var $selectBox = $('#2957867');
  $selectBox.change(function() {
    ...
    // Apply class logic to "Patron Type" dropdown. Needs a timer because it's embedded with logic.
    setTimeout(function() {
      var $patronTypeSelectBox = $('#2957887');
      $patronTypeSelectBox.change(function() {
        setTimeout(applyFieldClasses, 250);
      });
    }, 250);
  });
