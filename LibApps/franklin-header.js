    ...
    $.getScript("https://www.library.upenn.edu/scripts/login/login.js", function(){
      $.getScript("https://www.library.upenn.edu/scripts/login/json2.js", function(){
        $.getScript("https://www.library.upenn.edu/scripts/login/storage.js", function() {
          ...
          if($(".loggedin").length) {
              $(".ezproxy-show-not-logged-in").css('display', 'none');
              $(".ezproxy-show-logged-in").css('display', 'block');
          }
          else {
              $(".ezproxy-show-not-logged-in").css('display', 'block');
              $(".ezproxy-show-logged-in").css('display', 'none');
          }
...
var franklinHelpMenu = {
  'Your Franklin Account': {
    'url': 'https://guides.library.upenn.edu/franklinaccount',
    'guideID' : '858126',
  },
  'Using Franklin Catalog': {
    'url': 'https://guides.library.upenn.edu/franklincatalog',
    'guideID': '841528',
  },
  'Using Franklin Articles+': {
    'url': 'https://guides.library.upenn.edu/articlesplus',
    'guideID': '476328',
  },
};
