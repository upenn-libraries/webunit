    ...
    $.ajax({
        ...
        success: json => {
            ...
            json.faqs.forEach(faq => {
                ...
                var faqid = faq.faqid;
// Append questions
                    $("#fisherFaq").append("<dt><div class='dthead closed' tabindex='0' aria-controls='" + faqid + "' aria-expanded='false'>" + question + "</div></dt>");
                    $("#fisherFaq").append("<dd class='folded' id='" + faqid + "' aria-hidden='true'><p>" + answer + "</p></dd>");
